 ...
 * @return The number of pixels the element is scrolled. 0 indicates that the element is not scrolled at all (which, in general, is the left-most position in ltr and the right-most position in rtl).
 */
export declare function getScrollLeft(element: Element | null): number;
/**
 ...
 * @return The offsetStart for that element.
 */
export declare function getOffsetStart(element: Element | null): number;
/**
 ...
 */
export declare function setScrollOffset(element: Element | null, offsetStart: number): void;
/**
 ...
 */
export declare function setPosition(elem: Element | null, left: number, top: number | null, isRtl: boolean): void;
