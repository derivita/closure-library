...
declare namespace ಠ_ಠ.clutz.goog.crypt.base64 {
   ...
   */
  function decodeString (input : string , useCustomDecoder ? : boolean ) : string ;
  /**
   ...
   * @param alphabet Base 64 alphabet to use in encoding. Alphabet.DEFAULT is used by default.
   */
  function encodeString (input : string , alphabet ? : ಠ_ಠ.clutz.goog.crypt.base64.Alphabet ) : string ;
}
