 ...
 * Base-2, i.e. '01'.
 */
export declare var BASE_BINARY: string;
/**
 * Base-8, i.e. '01234567'.
 */
export declare var BASE_OCTAL: string;
/**
 * Base-10, i.e. '0123456789'.
 */
export declare var BASE_DECIMAL: string;
/**
 * Base-16 using lower case, i.e. '0123456789abcdef'.
 */
export declare var BASE_LOWERCASE_HEXADECIMAL: string;
/**
 * Base-16 using upper case, i.e. '0123456789ABCDEF'.
 */
export declare var BASE_UPPERCASE_HEXADECIMAL: string;
/**
 * The more-known version of the BASE-64 encoding.  Uses + and / characters.
 */
export declare var BASE_64: string;
/**
 * URL-safe version of the BASE-64 encoding.
 */
export declare var BASE_64_URL_SAFE: string;
/**
 ...
 */
export declare function recodeString(number: string, inputBase: string, outputBase: string): string;
