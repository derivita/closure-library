 ...
 */
export declare function createFloat32FromValues(v0: number, v1: number, v2: number): Float32;
/**
 ...
 * @return The new vector.
 */
export declare function createFloat64FromValues(v0: number, v1: number, v2: number): Float64;
/**
 ...
 * @return The new 3 element array.
 */
export declare function createFromArray(vec: Vec3Like | null): Type;
/**
 ...
 * @return The new cloned vector.
 */
export declare function clone(vec: Vec3Like | null): Type;
/**
 ...
 */
export declare function setFromValues(vec: AnyType | null, v0: number, v1: number, v2: number): AnyType;
/**
 ...
 */
export declare function dot(v0: AnyType | null, v1: AnyType | null): number;
/**
 ...
 * @return Return resultVec so that operations can be chained together.
 */
export declare function cross(v0: AnyType | null, v1: AnyType | null, resultVec: AnyType | null): AnyType;
/**
 ...
 * @return Return resultVec so that operations can be chained together.
 */
export declare function lerp(v0: AnyType | null, v1: AnyType | null, f: number, resultVec: AnyType | null): AnyType;
/**
 ...
 */
export declare function equals(v0: AnyType | null, v1: AnyType | null): boolean;
