...
import type * as Vec3 from './vec3.js';
...
export type Mat3Like = googVec.ArrayType;
/**
 ...
 * @return The new 9 element array.
 */
 ...
 * @return The new, nine element array.
 */
export declare function createFloat32FromValues(v00: number, v10: number, v20: number, v01: number, v11: number, v21: number, v02: number, v12: number, v22: number): Float32;
/**
 * Creates a clone of a 3x3 matrix of Float32.
 * @param matrix The source 3x3 matrix.
 * @return The new 3x3 element matrix.
 */
 ...
 * @return The new, nine element array.
 */
export declare function createFloat64FromValues(v00: number, v10: number, v20: number, v01: number, v11: number, v21: number, v02: number, v12: number, v22: number): Float64;
/**
 ...
 * @return The new, nine element array.
 */
export declare function createFromArray(matrix: Mat3Like | null): Type;
/**
 * Creates a 3x3 matrix of Float32 initialized from the given values.
 * @param v00 The values at (0, 0).
 * @param v10 The values at (1, 0).
 ...
 * @return The new, nine element array.
 */
export declare function createFromValues(v00: number, v10: number, v20: number, v01: number, v11: number, v21: number, v02: number, v12: number, v22: number): Type;
/**
 * Creates a clone of a 3x3 matrix of Float32.
 * @param matrix The source 3x3 matrix.
 * @return The new 3x3 element matrix.
 */
export declare function clone(a: Mat3Like | null): Type;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setFromValues(mat: AnyType | null, v00: number, v10: number, v20: number, v01: number, v11: number, v21: number, v02: number, v12: number, v22: number): AnyType | null;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setDiagonalValues(mat: AnyType | null, v00: number, v11: number, v22: number): AnyType | null;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setDiagonal(mat: AnyType | null, vec: Vec3.AnyType | null): AnyType | null;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setColumnValues(mat: AnyType | null, column: number, v0: number, v1: number, v2: number): AnyType | null;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setColumn(mat: AnyType | null, column: number, vec: Vec3.AnyType | null): AnyType | null;
/**
 ...
 */
export declare function getColumn(mat: AnyType | null, column: number, vec: Vec3.AnyType | null): Vec3.AnyType | null;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setColumns(mat: AnyType | null, vec0: Vec3.AnyType | null, vec1: Vec3.AnyType | null, vec2: Vec3.AnyType | null): AnyType | null;
/**
 ...
 */
export declare function getColumns(mat: AnyType | null, vec0: Vec3.AnyType | null, vec1: Vec3.AnyType | null, vec2: Vec3.AnyType | null): void;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setRowValues(mat: AnyType | null, row: number, v0: number, v1: number, v2: number): AnyType | null;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setRow(mat: AnyType | null, row: number, vec: Vec3.AnyType | null): AnyType | null;
/**
 ...
 * @return return vec so that operations can be chained together.
 */
export declare function getRow(mat: AnyType | null, row: number, vec: Vec3.AnyType | null): Vec3.AnyType | null;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setRows(mat: AnyType | null, vec0: Vec3.AnyType | null, vec1: Vec3.AnyType | null, vec2: Vec3.AnyType | null): AnyType | null;
/**
 ...
 */
export declare function getRows(mat: AnyType | null, vec0: Vec3.AnyType | null, vec1: Vec3.AnyType | null, vec2: Vec3.AnyType | null): void;
/**
 * Makes the given 3x3 matrix the zero matrix.
 * @param mat The matrix.
 * @return return mat so operations can be chained.
 */
export declare function makeZero(mat: AnyType | null): AnyType | null;
/**
 ...
 */
export declare function invert(mat0: AnyType | null, resultMat: AnyType | null): boolean;
/**
 ...
 */
export declare function makeTranslate(mat: AnyType | null, x: number, y: number): AnyType | null;
/**
 ...
 */
export declare function toEulerZXZ(mat: AnyType | null, euler: Vec3.AnyType | null, opt_theta2IsNegative?: boolean): Vec3.AnyType | null;
