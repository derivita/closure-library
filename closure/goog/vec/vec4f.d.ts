 ...
 * @return Return vec so that operations can be chained together.
 */
export declare function setFromVec4f(vec: Type, src: Type): Type;
/**
 ...
 * @return Return vec so that operations can be chained together.
 */
export declare function setFromVec4d(vec: Type, src: Float64Array | null): Type;
/**
