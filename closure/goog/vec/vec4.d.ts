...
export type Vec4Like = googVec.ArrayType;
/**
 ...
 * @return The new 4 element array.
 */
 ...
 * @return The new 4 element array.
 */
export declare function createFromArray(vec: Vec4Like | null): Type;
/**
 ...
 */
export declare function createFloat32FromValues(v0: number, v1: number, v2: number, v3: number): Float32;
/**
 ...
 * @return The new vector.
 */
export declare function createFloat64FromValues(v0: number, v1: number, v2: number, v3: number): Float64;
/**
 ...
 * @return The new cloned vector.
 */
export declare function clone(a: Vec4Like | null): Type;
/**
 ...
 */
export declare function setFromValues(vec: AnyType | null, v0: number, v1: number, v2: number, v3: number): AnyType;
/**
