 ...
 * @return Return mat so that operations can be chained together.
 */
export declare function setFromMat4d(mat: Type, src: Type): Type;
/**
 ...
 * @return Return mat so that operations can be chained together.
 */
export declare function setFromMat4f(mat: Type, src: Float32Array | null): Type;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setDiagonal(mat: Type, vec: vec4d.Type): Type;
/**
 ...
 */
export declare function getDiagonal(mat: Type, vec: vec4d.Type, opt_diagonal?: number): vec4d.Type;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setColumn(mat: Type, column: number, vec: vec4d.Type): Type;
/**
 ...
 * @return return vec so that operations can be chained together.
 */
export declare function getColumn(mat: Type, column: number, vec: vec4d.Type): vec4d.Type;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setColumns(mat: Type, vec0: vec4d.Type, vec1: vec4d.Type, vec2: vec4d.Type, vec3: vec4d.Type): Type;
/**
 ...
 */
export declare function getColumns(mat: Type, vec0: vec4d.Type, vec1: vec4d.Type, vec2: vec4d.Type, vec3: vec4d.Type): void;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setRow(mat: Type, row: number, vec: vec4d.Type): Type;
/**
 ...
 * @return return vec so that operations can be chained together.
 */
export declare function getRow(mat: Type, row: number, vec: vec4d.Type): vec4d.Type;
/**
 ...
 * @return return mat so that operations can be chained together.
 */
export declare function setRows(mat: Type, vec0: vec4d.Type, vec1: vec4d.Type, vec2: vec4d.Type, vec3: vec4d.Type): Type;
/**
 ...
 */
export declare function getRows(mat: Type, vec0: vec4d.Type, vec1: vec4d.Type, vec2: vec4d.Type, vec3: vec4d.Type): void;
/**
 ...
 */
export declare function multVec3(mat: Type, vec: vec3d.Type, resultVec: vec3d.Type): vec3d.Type;
/**
 * Transforms the given vector with the given matrix storing the resulting,
 * transformed vector into resultVec. The input vector is multiplied against the
 ...
 * @return return resultVec so that operations can be chained together.
 */
export declare function multVec3NoTranslate(mat: Type, vec: vec3d.Type, resultVec: vec3d.Type): vec3d.Type;
/**
 * Transforms the given vector with the given matrix storing the resulting,
 * transformed vector into resultVec. The input vector is multiplied against the
 ...
 * @return return resultVec so that operations can be chained together.
 */
export declare function multVec3Projective(mat: Type, vec: vec3d.Type, resultVec: vec3d.Type): vec3d.Type;
/**
 * Transforms the given vector with the given matrix storing the resulting,
 ...
 * @return return resultVec so that operations can be chained together.
 */
export declare function multVec4(mat: Type, vec: vec4d.Type, resultVec: vec4d.Type): vec4d.Type;
/**
 ...
 * @return return mat so that operations can be chained.
 */
export declare function makeRotationTranslation(mat: Type, rotation: Quaternion.AnyType, translation: vec3d.Type): Type;
/**
 ...
 * @return return mat so that operations can be chained.
 */
export declare function makeRotationTranslationScale(mat: Type, rotation: Quaternion.AnyType, translation: vec3d.Type, scale: vec3d.Type): Type;
/**
 * Creates a matrix from a quaternion rotation, vector translation, and
 ...
 * @return return mat so that operations can be chained.
 */
export declare function makeRotationTranslationScaleOrigin(mat: Type, rotation: Quaternion.AnyType, translation: vec3d.Type, scale: vec3d.Type, origin: vec3d.Type): Type;
/**
 ...
 * @return return mat so that operations can be chained.
 */
export declare function makeLookAt(mat: Type, eyePt: vec3d.Type, centerPt: vec3d.Type, worldUpVec: vec3d.Type): Type;
/**
 ...
 */
export declare function toLookAt(mat: Type, eyePt: vec3d.Type, fwdVec: vec3d.Type, worldUpVec: vec3d.Type): boolean;
/**
 ...
 */
export declare function toEulerZXZ(mat: Type, euler: vec3d.Type, opt_theta2IsNegative?: boolean): vec4d.Type;
/**
 ...
 */
export declare function getTranslation(mat: Type, translation: vec3d.Type): vec3d.Type;
