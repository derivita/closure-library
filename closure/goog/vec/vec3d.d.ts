 ...
 * @return Return vec so that operations can be chained together.
 */
export declare function setFromVec3d(vec: Type, src: Type): Type;
/**
 ...
 * @return Return vec so that operations can be chained together.
 */
export declare function setFromVec3f(vec: Type, src: Float32Array | null): Type;
/**
