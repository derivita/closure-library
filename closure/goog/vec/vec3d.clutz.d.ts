...
declare namespace ಠ_ಠ.clutz.goog.vec.vec3d {
   ...
   */
  function createFromValues (v0 : number , v1 : number , v2 : number ) : ಠ_ಠ.clutz.goog.vec.Float64 ;
  /**
   ...
   */
  function cross (v0 : ಠ_ಠ.clutz.goog.vec.Float64 , v1 : ಠ_ಠ.clutz.goog.vec.Float64 , resultVec : ಠ_ಠ.clutz.goog.vec.Float64 ) : ಠ_ಠ.clutz.goog.vec.Float64 ;
  /**
   ...
   * @param v2 The value for element at index 2.
   */
  function setFromValues (vec : ಠ_ಠ.clutz.goog.vec.Float64 , v0 : number , v1 : number , v2 : number ) : ಠ_ಠ.clutz.goog.vec.Float64 ;
  /**
   * Initializes vec3d vec from vec3d src.
   * @param vec The destination vector.
   * @param src The source vector.
   */
  function setFromVec3d (vec : ಠ_ಠ.clutz.goog.vec.Float64 , src : ಠ_ಠ.clutz.goog.vec.Float64 ) : ಠ_ಠ.clutz.goog.vec.Float64 ;
  /**
   ...
   * @param src The source vector.
   */
  function setFromVec3f (vec : ಠ_ಠ.clutz.goog.vec.Float64 , src : GlobalFloat32Array | null ) : ಠ_ಠ.clutz.goog.vec.Float64 ;
  /**
   ...
   * @param resultVec The vector to receive the results (may be v0 or v1).
   */
  function slerp (v0 : ಠ_ಠ.clutz.goog.vec.Float64 , v1 : ಠ_ಠ.clutz.goog.vec.Float64 , f : number , resultVec : ಠ_ಠ.clutz.goog.vec.Float64 ) : ಠ_ಠ.clutz.goog.vec.Float64 ;
  /**
...
declare module 'goog:goog.vec.vec3d' {
  import vec3d = ಠ_ಠ.clutz.goog.vec.vec3d;
  export = vec3d;
}
// Generated from vec/vec3d.js
declare namespace ಠ_ಠ.clutz.goog.vec.vec3d {
...
declare module 'goog:goog.vec.vec3d.Type' {
  import Type = ಠ_ಠ.clutz.goog.vec.vec3d.Type;
  export default Type;
}
