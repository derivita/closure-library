 ...
 * @return Return vec so that operations can be chained together.
 */
export declare function setFromVec2f(vec: Type, src: Type): Type;
/**
 ...
 * @return Return vec so that operations can be chained together.
 */
export declare function setFromVec2d(vec: Type, src: Float64Array | null): Type;
/**
