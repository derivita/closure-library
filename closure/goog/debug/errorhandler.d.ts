 ...
 * forms of unwrapping.
 */
export declare class ErrorHandler extends Disposable implements entryPointRegistry.EntryPointMonitor {
    /**
     * The ErrorHandler can be used to to wrap functions with a try/catch
     * statement. If an exception is thrown, the given error handler function will
     * be called.
    ...
    private noStructuralTyping_closure_goog_debug_errorhandler_ErrorHandler;
    wrap(fn: any): any;
    unwrap(fn: any): any;
    /**
     ...
     * @return A protected wrapper function that calls the entry point function.
     */
     ...
     * entry point hooks.
     * @param fn An entry point function to be protected.
     * @return protected wrapper function.
     */
...
export declare namespace ErrorHandler {
    ...
    class ProtectedFunctionError extends DebugError {
        ...
        private noStructuralTyping_closure_goog_debug_errorhandler_ProtectedFunctionError;
        /**
