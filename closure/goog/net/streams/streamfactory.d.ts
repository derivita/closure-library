import type { NodeReadableStream } from './nodereadablestream.js';
import type { XhrIo } from '../xhrio.js';
/**
 ...
 * @return the newly created stream or null if streaming response is not supported by the current User Agent.
 */
declare function createXhrNodeReadableStream(xhr: XhrIo): NodeReadableStream | null;
declare const _default: {
    createXhrNodeReadableStream: typeof createXhrNodeReadableStream;
};
