...
import type { LazyDeserializer } from './lazydeserializer.js';
/**
...
export declare class Message {
     ...
     */
    constructor();
    private noStructuralTyping_closure_goog_proto2_message_Message;
    /**
     ...
     */
    initializeForLazyDeserializer(deserializer: LazyDeserializer | null, data: any): void;
    /**
     ...
     */
    forEachUnknown<T = any>(callback: (this: T | null) => any, opt_scope?: T | null): void;
    /**
     ...
     */
    has(field: FieldDescriptor | null): boolean;
    /**
     ...
     */
    arrayOf(field: FieldDescriptor | null): any[];
    /**
     * Returns the number of values stored in the given field.
     * @param field The field for which to count the number of values.
     * @return The count of the values in the given field.
     */
    countOf(field: FieldDescriptor | null): number;
    /**
     ...
     */
    get(field: FieldDescriptor | null, opt_index?: number): any;
    /**
     * Returns the value stored at the field specified by the
     ...
     */
    getOrDefault(field: FieldDescriptor | null, opt_index?: number): any;
    /**
     ...
     */
    set(field: FieldDescriptor | null, value: any): void;
    /**
     ...
     */
    add(field: FieldDescriptor | null, value: any): void;
    /**
     * Clears the field specified.
     * @param field The field to clear.
     */
    clear(field: FieldDescriptor | null): void;
    /**
     * Compares this message with another one ignoring the unknown fields.
     * @param other The other message.
     * @return Whether they are equal. Returns false if the `other` argument is a different type of message or not a message.
     */
     ...
     * @param message The source message.
     */
    mergeFrom(message: Message): void;
    clone(): Message;
    /**
     ...
     * @param tag The tag.
     * @return Whether the message has a value for the field.
     */
     ...
     * @param tag The field's tag index.
     * @return The values found. If none, returns an empty array.
     */
     ...
     */
    static createDescriptor(messageType: {
        new (): Message | null;
    }, metadataObj: object): Descriptor;
}
