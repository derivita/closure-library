...
export declare namespace KeyCodes {
    /**
     ...
     */
    var isTextModifyingKeyEvent: boolean;
    /**
     ...
     * @param opt_metaKey Whether the meta key is held down.
     * @return Whether it's a key that fires a keypress event.
     */
    var firesKeyPressEvent: boolean;
    /**
     ...
     */
    var isCharacterKey: boolean;
    /**
     * Normalizes key codes from OS/Browser-specific value to the general one.
     * @param keyCode The native key code.
     * @return The normalized key code.
     */
    var normalizeKeyCode: number;
    /**
     * Normalizes key codes from their Gecko-specific value to the general one.
     * @param keyCode The native key code.
     * @return The normalized key code.
     */
    var normalizeGeckoKeyCode: number;
    /**
     * Normalizes key codes from their Mac WebKit-specific value to the general one.
     * @param keyCode The native key code.
     * @return The normalized key code.
     */
    var normalizeMacWebKitKeyCode: number;
}
