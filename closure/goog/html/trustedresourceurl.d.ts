 ...
 */
export declare class TrustedResourceUrl implements TypedString {
    constructor(value: TrustedScriptURL | string, token: object);
    /**
     ...
     * @param searchParams Search parameters to add to URL. See TrustedResourceUrl.stringifyParams_ for exact format definition.
     * @param opt_hashParams Hash parameters to add to URL. See TrustedResourceUrl.stringifyParams_ for exact format definition.
     * @return New TrustedResourceUrl with params.
     */
    cloneWithParams(searchParams: string | {
        [key: string]: any;
    } | undefined | null, opt_hashParams?: string | {
        [key: string]: any;
    } | null): TrustedResourceUrl;
    /**
     * Performs a runtime check that the provided object is indeed a
     * TrustedResourceUrl object, and returns its value.
     * @param trustedResourceUrl The object to extract from.
     * @return The trustedResourceUrl object's contained string, unless the run-time type check fails. In that case, `unwrap` returns an innocuous string, or, if assertions are enabled, throws `asserts.AssertionError`.
     */
     ...
     */
    static unwrapTrustedScriptURL(trustedResourceUrl: TrustedResourceUrl): TrustedScriptURL | string;
    /**
     ...
     * @param args Mapping of labels to values to be interpolated into the format string. Const values are interpolated without encoding.
     */
    static format(format: Const, args: {
        [key: string]: string | number | Const;
    }): TrustedResourceUrl;
    /**
     ...
     * @param format The format string.
     * @param args Mapping of labels to values to be interpolated into the format string. Const values are interpolated without encoding.
     * @param searchParams Parameters to add to URL. See TrustedResourceUrl.stringifyParams_ for exact format definition.
     * @param opt_hashParams Hash parameters to add to URL. See TrustedResourceUrl.stringifyParams_ for exact format definition.
     */
     ...
     * @return A TrustedResourceUrl object initialized to `url`.
     */
     ...
     * @return A TrustedResourceUrl object initialized to concatenation of `parts`.
     */
    static fromConstants(parts: Const[]): TrustedResourceUrl;
    /**
     ...
     * @return A TrustedResourceUrl object initialized to a new blob URL.
     */
