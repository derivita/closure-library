 ...
 */
export type HtmlSanitizerPolicy = () => (string | null);
/**
 * Type for a URL policy function.
 */
export type HtmlSanitizerUrlPolicy = () => (SafeUrl | null);
/**
 ...
 */
export declare class HtmlSanitizer extends SafeDomTreeProcessor {
    /**
     * Creates an HTML sanitizer.
     */
    constructor(opt_builder?: HtmlSanitizer.Builder);
    private noStructuralTyping_closure_goog_html_sanitizer_htmlsanitizer_HtmlSanitizer;
    /**
    ...
    processRoot(newRoot: any): any;
    preProcessHtml(unsanitizedHtml: any): string;
    createTextNode(dirtyNode: any): Text;
    createElementWithoutAttributes(dirtyElement: any): Element;
    processElementAttribute(dirtyElement: any, attribute: any): string;
    /**
...
export declare namespace HtmlSanitizer {
    /**
    ...
    class Builder {
         ...
         */
        constructor();
        private noStructuralTyping_closure_goog_html_sanitizer_htmlsanitizer_Builder;
        /**
         * Extends the list of allowed data attributes.
         */
        allowDataAttributes(dataAttributeWhitelist: string[]): HtmlSanitizer.Builder;
        /**
         * Extends the list of allowed custom element tags.
         */
        allowCustomElementTags(customElementTagWhitelist: string[]): HtmlSanitizer.Builder;
        /**
         * Extends the list of allowed custom element tags.
         */
        allowCustomElementTag(customElementTagName: string, customElementAttributes?: string[]): HtmlSanitizer.Builder;
        /**
         * Allows form tags in the HTML. Without this all form tags and content will be
         * dropped.
         */
        allowFormTag(): HtmlSanitizer.Builder;
        /**
         ...
         */
        allowStyleTag(): HtmlSanitizer.Builder;
        /**
         ...
         */
        withStyleContainer(opt_styleContainer?: string): HtmlSanitizer.Builder;
        /**
         ...
         * allowStyleTag}.
         */
        inlineStyleRules(): HtmlSanitizer.Builder;
        /**
         * Allows inline CSS styles.
         */
        allowCssStyles(): HtmlSanitizer.Builder;
        /**
         ...
         */
        onlyAllowTags(tagWhitelist: string[]): HtmlSanitizer.Builder;
        /**
         ...
         */
        onlyAllowAttributes(attrWhitelist: (string | HtmlSanitizerAttributePolicy)[]): HtmlSanitizer.Builder;
        /**
         ...
         * actual &lt;span&rt; tags.
         */
        addOriginalTagNames(): HtmlSanitizer.Builder;
        /**
         * Sets a custom network URL policy.
         */
        withCustomNetworkRequestUrlPolicy(customNetworkReqUrlPolicy: HtmlSanitizerUrlPolicy): HtmlSanitizer.Builder;
        /**
         * Sets a custom non-network URL policy.
         */
        withCustomUrlPolicy(customUrlPolicy: HtmlSanitizerUrlPolicy): HtmlSanitizer.Builder;
        /**
         * Sets a custom name policy.
         */
        withCustomNamePolicy(customNamePolicy: HtmlSanitizerPolicy): HtmlSanitizer.Builder;
        /**
         * Sets a custom token policy.
         */
        withCustomTokenPolicy(customTokenPolicy: HtmlSanitizerPolicy): HtmlSanitizer.Builder;
        /**
