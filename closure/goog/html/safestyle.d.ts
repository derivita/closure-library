 ...
 * </ul>
 */
declare class SafeStyle implements TypedString {
     ...
     */
    static concat(...var_args: (SafeStyle | SafeStyle[])[]): SafeStyle;
...
declare namespace SafeStyle {
     ...
     */
    type PropertyMap = {
        [key: string]: SafeStyle.PropertyValue | SafeStyle.PropertyValue[] | null;
    };
}
export { SafeStyle };
