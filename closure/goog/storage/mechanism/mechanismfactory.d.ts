import type { IterableMechanism } from './iterablemechanism.js';
/**
 * The key to shared userData storage.
 */
export declare var USER_DATA_SHARED_KEY: string;
/**
 ...
 * @return Created mechanism or null.
 */
export declare function create(opt_namespace?: string): IterableMechanism | null;
/**
 ...
 * @return Created mechanism or null.
 */
export declare function createHTML5LocalStorage(opt_namespace?: string): IterableMechanism | null;
/**
 ...
 * @return Created mechanism or null.
 */
export declare function createHTML5SessionStorage(opt_namespace?: string): IterableMechanism | null;
/**
 ...
 * @return Created mechanism or null.
 */
export declare function createIEUserData(opt_namespace?: string): IterableMechanism | null;
