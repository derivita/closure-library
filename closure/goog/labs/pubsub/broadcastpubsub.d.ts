 ...
 */
export declare class BroadcastPubSub extends Disposable {
    /**
     * Topic-based publish/subscribe messaging implementation that provides
     * communication between browsing contexts that share the same origin.
     *
     ...
     */
    constructor();
    private noStructuralTyping_closure_goog_labs_pubsub_broadcastpubsub_BroadcastPubSub;
    /**
...
export declare namespace BroadcastPubSub {
    /**
