 ...
 */
export declare var NETWORK_TIMEOUT: number;
/**
 ...
 */
export declare function testNetwork(callback: () => any, opt_imageUri?: Uri | null): void;
/**
 ...
 */
export declare function testLoadImageWithRetries(url: string, timeout: number, callback: () => any, retries: number, channelDebug: WebChannelDebug, opt_pauseBetweenRetriesMS?: number): void;
/**
 ...
 * @param callback Function to call with results.
 */
export declare function testLoadImage(url: string, timeout: number, callback: () => any): void;
