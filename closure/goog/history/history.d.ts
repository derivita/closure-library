 ...
 * </pre>
 */
export declare class History extends EventTarget {
    /**
     * A history management object. Can be instantiated in user-visible mode (uses
     * the address fragment to manage state) or in hidden mode. This object should
     * be created from a script in the document body before the document has
     ...
     */
    constructor(opt_invisible?: boolean, opt_blankPageUrl?: TrustedResourceUrl, opt_input?: HTMLInputElement | null, opt_iframe?: HTMLIFrameElement | null);
    private noStructuralTyping_closure_goog_history_history_History;
    /**
     ...
     * @return Whether onhashchange is supported.
     */
    static isOnHashChangeSupported(...args: any[]): boolean;
    /**
...
export declare namespace History {
    ...
    const EventType: typeof historyEventType;
    /**
     * Constant for the history change event type.
     */
    var Event: typeof historyEvent;
}
