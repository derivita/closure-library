//!! generated by clutz.
// Generated from testing/net/mockiframeio.js
declare namespace ಠ_ಠ.clutz.goog.testing.net {
  ...
  class MockIFrameIo extends ಠ_ಠ.clutz.goog.events.EventTarget {
    private noStructuralTyping_goog_testing_net_MockIFrameIo : any;
    /**
     * Mock implementation of goog.net.IframeIo. This doesn't provide a mock
     * implementation for all cases, but it's not too hard to add them as needed.
...
declare module 'goog:goog.testing.net.MockIFrameIo' {
  import MockIFrameIo = ಠ_ಠ.clutz.goog.testing.net.MockIFrameIo;
