 ...
 * @return The previous (in document order) node from the given node that is a non-empty text node, or null if none is found.
 */
export declare function getPreviousNonEmptyTextNode(node: Node | null, opt_stopAt?: Node | null, opt_skipDescendants?: boolean): Text | null;
/**
 ...
 * @param opt_stopAt Node to stop searching at (search will be restricted to this node's subtree), defaults to the body of the document containing node.
 * @param opt_skipDescendants Whether to skip searching the given node's descentants.
 * @return The next (in document order) node from the given node that is a non-empty text node, or null if none is found or opt_stopAt is not an ancestor of node.
 */
export declare function getNextNonEmptyTextNode(node: Node | null, opt_stopAt?: Node | null, opt_skipDescendants?: boolean): Text | null;
/**
 ...
 */
export declare function assertRangeBetweenText(before: string, after: string, range: AbstractRange | null, opt_stopAt?: Node | null): void;
