...
export declare const TagWalkType: {
    START_TAG: number;
    OTHER: number;
    END_TAG: number;
};
 ...
 */
export declare class TagIterator extends Iterator<Node | null> {
    /**
     * A DOM tree traversal iterator.
     *
     * Starting with the given node, the iterator walks the DOM in order, reporting
     ...
     */
    constructor(opt_node?: Node | null, opt_reversed?: boolean, opt_unconstrained?: boolean, opt_tagType?: TagWalkType | null, opt_depth?: number);
    private noStructuralTyping_closure_goog_dom_tagiterator_TagIterator;
    /**
     ...
     */
    setPosition(node: Node | null, opt_tagType?: TagWalkType | null, opt_depth?: number): void;
    /**
     ...
     * @return Whether the two iterators are at the same position.
     */
     ...
     */
    splice(...var_args: (object | null)[]): void;
}
