 ...
 */
export declare var BLANK_SOURCE_URL: TrustedResourceUrl;
/**
 * Legacy version of BLANK_SOURCE_URL.
 */
export declare var BLANK_SOURCE: string;
/**
 ...
 */
export declare var BLANK_SOURCE_NEW_FRAME_URL: TrustedResourceUrl;
/**
 * Legacy version of BLANK_SOURCE_NEW_FRAME_URL.
 */
export declare var BLANK_SOURCE_NEW_FRAME: string;
/**
 ...
 * @return A completely blank iframe.
 */
export declare function createBlank(domHelper: dom.DomHelper | null, opt_styles?: SafeStyle): HTMLIFrameElement;
/**
 ...
 */
export declare function writeSafeContent(iframe: HTMLIFrameElement, content: SafeHtml): void;
/**
 ...
 * @return An iframe that has the specified contents.
 */
export declare function createWithContent(parentElement: Element, opt_headContents?: SafeHtml, opt_bodyContents?: SafeHtml, opt_styles?: SafeStyle, opt_quirks?: boolean): HTMLIFrameElement;
