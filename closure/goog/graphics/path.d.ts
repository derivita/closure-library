//!! generated by clutz.
// Generated from graphics/path.js
declare namespace ಠ_ಠ.clutz.goog.graphics {
   ...
   */
  class Path {
    private noStructuralTyping_goog_graphics_Path : any;
    /**
     ...
     */
    curveTo ( ...var_args : number [] ) : ಠ_ಠ.clutz.goog.graphics.Path ;
    /**
     ...
     */
    lineTo ( ...var_args : number [] ) : ಠ_ಠ.clutz.goog.graphics.Path ;
    /**
...
declare module 'goog:goog.graphics.Path' {
  import Path = ಠ_ಠ.clutz.goog.graphics.Path;
  export default Path;
}
// Generated from graphics/path.js
...
declare module 'goog:goog.graphics.Path.Segment' {
  import Segment = ಠ_ಠ.clutz.goog.graphics.Path.Segment;
