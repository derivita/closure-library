...
declare namespace ಠ_ಠ.clutz.goog.ui {
  ...
  class KeyboardShortcutHandler extends ಠ_ಠ.clutz.goog.events.EventTarget {
     ...
     * @param var_args See below. param {number} keyCode Numeric code for key param {number=} opt_modifiers Bitmap indicating required modifier keys. goog.ui.KeyboardShortcutHandler.Modifiers.SHIFT, CTRL, ALT, or META. The last two parameters can be repeated any number of times to create a shortcut using a sequence of strokes. Instead of varargs the second parameter could also be an array where each element would be regarded as a parameter. A string representation of the shortcut can be supplied instead of the last two parameters. In that case the method only takes two arguments, the identifier and the string. Examples: up              registerShortcut(str, goog.events.KeyCodes.UP) Ctrl+g          registerShortcut(str, G_KEYCODE, CTRL) Ctrl+Shift+g    registerShortcut(str, G_KEYCODE, CTRL | SHIFT) Ctrl+g a        registerShortcut(str, G_KEYCODE, CTRL, A_KEYCODE) Ctrl+g Shift+a  registerShortcut(str, G_KEYCODE, CTRL, A_KEYCODE, SHIFT) Examples using string representation for shortcuts: up              registerShortcut(str, 'up') Ctrl+g          registerShortcut(str, 'ctrl+g') Ctrl+Shift+g    registerShortcut(str, 'ctrl+shift+g') Ctrl+g a        registerShortcut(str, 'ctrl+g a') Ctrl+g Shift+a  registerShortcut(str, 'ctrl+g shift+a')
     */
