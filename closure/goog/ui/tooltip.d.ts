...
export declare class Tooltip extends Popup {
     ...
     */
    constructor(opt_el?: Element | string | null, opt_str?: string | null, opt_domHelper?: googDom.DomHelper | null);
    private noStructuralTyping_closure_goog_ui_tooltip_Tooltip;
    /**
     ...
     */
    detach(opt_el?: Element | string | null): void;
    /**
    ...
    protected getElements(): Set | null;
    getActiveElement(): Element | null;
    /**
     *
     * @param activeEl Active element reference.
     */
     ...
     * @param opt_pos Position to display popup at.
     */
    showForElement(el: Element | null, opt_pos?: AbstractPosition | null): void;
    /**
     ...
     */
    protected handleMouseOver(event: BrowserEvent | null): void;
    /**
     * Find anchor containing the given element, if any.
     * @param el Element that triggered event.
     * @return Element in elements_ array that contains given element, or null if not found.
     */
     ...
     */
    protected handleMouseMove(event: BrowserEvent | null): void;
    /**
     * Handler for focus events.
     * @param event Event object.
     */
    protected handleFocus(event: BrowserEvent | null): void;
    /**
     ...
     * @return The position object used to position the tooltip.
     */
    protected getPositioningStrategy(activationType: Tooltip.Activation | null): AbstractPosition;
    /**
     * Handler for mouse out and blur events.
     * @param event Event object.
     */
    protected handleMouseOutAndBlur(event: BrowserEvent | null): void;
    /**
     * Handler for mouse over events for the tooltip element.
     * @param event Event object.
     */
    protected handleTooltipMouseOver(event: BrowserEvent | null): void;
    /**
     * Handler for mouse out events for the tooltip element.
     * @param event Event object.
     */
    protected handleTooltipMouseOut(event: BrowserEvent | null): void;
    /**
     ...
     * @param opt_pos Position to display popup at.
     */
    protected startShowTimer(el: Element | null, opt_pos?: AbstractPosition | null): void;
    /**
...
export declare namespace Tooltip {
    ...
    class CursorTooltipPosition extends ViewportPosition {
        ...
        private noStructuralTyping_closure_goog_ui_tooltip_CursorTooltipPosition;
        /**
         ...
         */
        reposition(element: Element | null, popupCorner: Corner | null, opt_margin?: Box | null): void;
    }
    /**
     * Popup position implementation that positions the popup (the tooltip in this
    ...
    class ElementTooltipPosition extends AnchoredPosition {
        ...
        private noStructuralTyping_closure_goog_ui_tooltip_ElementTooltipPosition;
        /**
