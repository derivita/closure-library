//!! generated by clutz.
// Generated from ui/ac/cachingmatcher.js
declare namespace ಠ_ಠ.clutz.goog.ui.ac {
  ...
  class CachingMatcher {
    private noStructuralTyping_goog_ui_ac_CachingMatcher : any;
    /**
     * A matcher which wraps another (typically slow) matcher and
     * keeps a client-side cache of the results. For instance, you can use this to
     * wrap a RemoteArrayMatcher to hide the latency of the underlying matcher
     ...
     */
    setLocalMatcher (localMatcher : (a : string , b : number , c : GlobalObject [] ) => GlobalObject [] ) : void ;
    /**
...
declare module 'goog:goog.ui.ac.CachingMatcher' {
  import CachingMatcher = ಠ_ಠ.clutz.goog.ui.ac.CachingMatcher;
  export default CachingMatcher;
}
