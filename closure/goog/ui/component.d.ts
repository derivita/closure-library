...
export declare class Component extends EventTarget {
    ...
    private noStructuralTyping_closure_goog_ui_component_Component;
    /**
     * DomHelper used to interact with the document, allowing components to be
     * created in a different window.
     */
    protected dom_: dom.DomHelper;
     ...
     * @return Event type to dispatch.
     */
    static getStateTransitionEvent(state: Component.State | null, isEntering: boolean): Component.ComponentEventType | null;
    /**
     ...
     * @return An object of id keys to generated ids.
     */
    makeIds(object: object | null): {
        [key: string]: string;
    };
    /**
     ...
     * @return The element with the unique id, or null if it cannot be found.
     */
     ...
     */
    forEachChild<T = any>(f: (this: T | null) => any, opt_obj?: T | null): void;
    /**
     ...
     */
    removeChild(child: string | Component | null | null, opt_unrender?: boolean): Component | null;
    /**
     ...
     * @return The removed component, if any.
     */
    removeChildAt(index: number, opt_unrender?: boolean): Component | null;
    /**
     ...
     * @return The removed components if any.
     */
    removeChildren(opt_unrender?: boolean): (Component | null)[];
    /**
