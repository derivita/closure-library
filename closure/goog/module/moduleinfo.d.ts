...
import type { ModuleLoadFailure } from './moduleloadfailure.js';
/**
 ...
 */
export declare class ModuleInfo extends Disposable {
    /**
     * A ModuleInfo object is used by the ModuleManager to hold information about a
     * module of js code that may or may not yet be loaded into the environment.
    ...
    private noStructuralTyping_closure_goog_module_moduleinfo_ModuleInfo;
    /**
     * Gets the dependencies of this module.
     * @return The ids of the modules that this module depends on.
     */
     ...
     */
    setTrustedUris(uris: TrustedResourceUrl[]): void;
    /**
     * Gets the uris of this module.
     * @return Uris for this module's code.
     */
    getUris(): TrustedResourceUrl[];
    /**
     * Sets the constructor to use to instantiate the module object after the
     * module code is loaded.
     * @param constructor The constructor of a BaseModule subclass.
     */
     ...
     */
    registerEarlyCallback(fn: Function | null, opt_handler?: object | null): ModuleLoadCallback;
    /**
     ...
     * @return Reference to the callback object.
     */
    registerCallback(fn: Function | null, opt_handler?: object | null): ModuleLoadCallback;
    /**
     ...
     * @return Reference to the callback object.
     */
    registerErrback(fn: Function | null, opt_handler?: object | null): ModuleLoadCallback;
    /**
    ...
    /**
     * Gets the module.
     * @return The module if it has been loaded. Otherwise, null.
     */
    getModule(): BaseModule | null;
    /**
     * Sets this module as loaded.
     * @param contextProvider A function that provides the module context.
     * @return Whether any errors occurred while executing the onload callbacks.
     */
    onLoad(contextProvider: () => (object | null)): boolean;
    /**
     * Calls the error callbacks for the module.
     * @param cause What caused the error.
     */
    onError(cause: ModuleLoadFailure): void;
