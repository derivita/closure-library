...
export declare class Loader {
     ...
     */
    constructor();
    private noStructuralTyping_closure_goog_module_loader_Loader;
    /**
     * Wrapper of Loader.require() for use in modules.
     * See method Loader.require() for
     * explanation of params.
     * @param module The name of the module. Usually, the value is defined as a constant whose name starts with MOD_.
     * @param symbol The ID of the symbol. Usually, the value is defined as a constant whose name starts with SYM_.
     * @param callback This function will be called with the resolved symbol as the argument once the module is loaded.
     */
    static require(module: string, symbol: number | string, callback: Function | null): void;
    /**
     * Wrapper of Loader.provide() for use in modules
     * See method Loader.provide() for explanation of params.
     * @param module The name of the module. Cf. parameter module of method require().
     * @param opt_symbol The symbol being defined, or nothing when all symbols of the module are defined. Cf. parameter symbol of method require().
     * @param opt_object The object bound to the symbol, or nothing when all symbols of the module are defined.
     */
    static provide(module: string, opt_symbol?: number | string, opt_object?: object | null): void;
    /**
     ...
     * @param opt_urlFunction Function that creates the URL for the module file. It will be passed the base URL for module files and the module name and should return the fully-formed URL to the module file to load.
     */
    static init(urlBase: string, opt_urlFunction?: Function | null): void;
    /**
     ...
     * @param symbol The ID of the symbol to load from the module. This symbol must resolve to a function.
     * @return A function that forwards all its arguments to the dynamically loaded function specified by module and symbol.
     */
     ...
     * @param opt_urlFunction Function that creates the URL for the module file. It will be passed the base URL for module files and the module name and should return the fully-formed URL to the module file to load.
     */
    init(baseUrl: string, opt_urlFunction?: Function | null): void;
    /**
     ...
     * @param callback This function will be called with the resolved symbol as the argument once the module is loaded.
     */
    require(module: string, symbol: number | string, callback: Function | null): void;
    /**
     ...
     * @param opt_object The object bound to the symbol, or nothing when all symbols of the module are defined.
     */
    provide(module: string, opt_symbol?: number | string, opt_object?: object | null): void;
}
