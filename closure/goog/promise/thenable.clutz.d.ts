...
declare namespace ಠ_ಠ.clutz.goog {
  export import Thenable = ಠ_ಠ.clutz.module$contents$goog$Thenable_Thenable ;
}
...
declare namespace ಠ_ಠ.clutz {
   ...
   */
  namespace module$contents$goog$Thenable_Thenable {
    let /**
     ...
     */
    addImplementation (ctor : { new ( ...a : any [] ) : module$contents$goog$Thenable_Thenable < any > } ) : void ;
    function isImplementedBy (object ? : any ) : boolean ;
  }
  interface module$contents$goog$Thenable_Thenable < TYPE = any > extends PromiseLike < TYPE > {
    /**
     ...
     */
    then < RESULT > (opt_onFulfilled ? : ( (a : TYPE ) => PromiseLike < RESULT > | RESULT ) | null , opt_onRejected ? : ( (a : any ) => any ) | null) : ಠ_ಠ.clutz.module$contents$goog$Thenable_Thenable < RESULT > ;
  }
}
declare namespace ಠ_ಠ.clutz {
  export import module$exports$goog$Thenable = ಠ_ಠ.clutz.module$contents$goog$Thenable_Thenable ;
}
