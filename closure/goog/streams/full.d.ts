import { ReadableStream, ReadableStreamStrategy, ReadableStreamUnderlyingSource } from './full_types.js';
/**
 ...
 * properties.
 */
declare function newReadableStream<T = any>(underlyingSource?: ReadableStreamUnderlyingSource<T | null>, strategy?: ReadableStreamStrategy<T | null>): ReadableStream<T | null>;
