 ...
 */
export interface ReadableStreamDefaultController<T = any> {
    /**
 ...
 */
export interface ReadableStreamUnderlyingSource<T = any> {
    /**
     ...
     */
    start: (() => (Promise<undefined> | undefined)) | undefined;
}
