 ...
 */
export declare class AbstractBubblePlugin extends Plugin {
    /**
     * Base class for bubble plugins. This is used for to connect user behavior
     * in the editor to a Bubble UI element that allows
     * the user to modify the properties of an element on their page (e.g. the alt
     ...
     */
    constructor();
    private noStructuralTyping_closure_goog_editor_plugins_abstractbubbleplugin_AbstractBubblePlugin;
    /**
     * Place to register events the plugin listens to.
     */
    protected eventRegister: EventHandler<AbstractBubblePlugin> | null;
    /**
     ...
     */
    static setBubbleFactory(bubbleFactory: () => Bubble): void;
    /**
     ...
     */
    setBubbleFactory(bubbleFactory: (() => Bubble) | null): void;
    /**
     ...
     */
    protected getBubbleMap(): {
        [key: string]: Bubble | null;
    };
    getBubbleDom(): dom.DomHelper | null;
    /**
     ...
     */
    handleSelectionChange(opt_e: any, opt_target: any): boolean;
    /**
     * Pops up a property bubble for the given selection if appropriate and closes
     * open property bubbles if no longer needed.
     * @param selectedElement The selected element.
     * @return Always false, allowing every bubble plugin to handle the event.
     */
     ...
     * @return The HTML bubble target element or null if no element of the required type is not found.
     */
    ...
    protected shouldPreferBubbleAboveElement(...args: any[]): boolean;
    /**
     ...
     */
    protected createBubbleContents(bubbleContainer: Element | null): void;
    /**
     * Register the handler for the target's CLICK event.
     * @param target The event source element.
     * @param handler The event handler.
     */
    protected registerClickHandler(target: Element | null, handler: Function | null): void;
    /**
     * Register the handler for the target's CLICK and ENTER key events.
     * @param target The event source element.
     * @param handler The event handler.
     */
    protected registerActionHandler(target: Element | null, handler: Function | null): void;
    /**
     * Closes the bubble.
     */
    closeBubble(): void;
     ...
     */
    protected createLinkOption(id: string): Element | null;
    /**
     ...
     */
    protected createLink(linkId: string, linkText: string, opt_onClick?: Function | null, opt_container?: Element | null): Element | null;
    /**
     ...
     * @return The link element.
     */
    protected createLinkHelper(linkId: string, linkText: string, isAnchor: boolean, opt_container?: Element | null): Element | null;
    /**
     ...
     */
    protected setupLink(link: Element | null, linkId: string, opt_container?: Element | null): void;
}
