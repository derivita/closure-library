//!! generated by clutz.
// Generated from editor/style.js
declare namespace ಠ_ಠ.clutz.goog.editor.style {
   ...
   */
  function makeUnselectable (element : GlobalElement | null , eventHandler : ಠ_ಠ.clutz.goog.events.EventHandler | null ) : void ;
}
declare module 'goog:goog.editor.style' {
  import style = ಠ_ಠ.clutz.goog.editor.style;
  export = style;
}
