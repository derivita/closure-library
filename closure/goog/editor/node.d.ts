 ...
 * @return Whether the node is in a standards mode document.
 */
export declare function isStandardsMode(node: Node | null): boolean;
/**
 * Get the right-most non-ignorable leaf node of the given node.
 * @param parent The parent ndoe.
 * @return The right-most non-ignorable leaf node.
 */
export declare function getRightMostLeaf(parent: Node | null): Node | null;
/**
 * Get the left-most non-ignorable leaf node of the given node.
 * @param parent The parent ndoe.
 * @return The left-most non-ignorable leaf node.
 */
export declare function getLeftMostLeaf(parent: Node | null): Node | null;
/**
 * Version of firstChild that skips nodes that are entirely
 * whitespace and comments.
 * @param parent The reference node.
 * @return The first child of sibling that is important according to isImportant, or null if no such node exists.
 */
export declare function getFirstChild(parent: Node | null): Node | null;
/**
 ...
 * @param parent The reference node.
 * @return The last child of sibling that is important according to isImportant, or null if no such node exists.
 */
export declare function getLastChild(parent: Node | null): Node | null;
/**
 ...
 * @return The closest previous sibling to sibling that is important according to isImportant, or null if no such node exists.
 */
export declare function getPreviousSibling(sibling: Node | null): Node | null;
/**
 * Version of nextSibling that skips nodes that are entirely whitespace or
 * comments.
 * @param sibling The reference node.
 * @return The closest next sibling to sibling that is important according to isImportant, or null if no such node exists.
 */
export declare function getNextSibling(sibling: Node | null): Node | null;
/**
 ...
 * @return Whether the node is an element, or a text node that is not all whitespace.
 */
export declare function isImportant(node: Node | null): boolean;
/**
 * Determine whether a node's text content is entirely whitespace.
 * @param textNode A node implementing the CharacterData interface (i.e., a Text, Comment, or CDATASection node.
 * @return Whether the text content of node is whitespace, otherwise false.
 */
export declare function isAllNonNbspWhiteSpace(textNode: Node | null): boolean;
/**
 ...
 * @return Whether the node contains only whitespace.
 */
export declare function isEmpty(node: Node | null, opt_prohibitSingleNbsp?: boolean): boolean;
/**
 ...
 */
export declare function getLength(node: Node | null): number;
/**
 ...
 * @return The index of the node found, or null if no node is found.
 */
export declare function findInChildren(parent: Node | null, hasProperty: () => boolean): number | null;
/**
 ...
 * @return The topmost ancestor or null if no ancestor satisfies the predicate function.
 */
export declare function findHighestMatchingAncestor(node: Node | null, hasProperty: () => boolean): Node | null;
/**
 * Checks if node is a block-level html element. The <tt>display</tt> css
 * property is ignored.
 * @param node The node to test.
 * @return Whether the node is a block-level node.
 */
export declare function isBlockTag(node: Node | null): boolean;
/**
 * Skips siblings of a node that are empty text nodes.
 * @param node A node. May be null.
 * @return The node or the first sibling of the node that is not an empty text node. May be null.
 */
export declare function skipEmptyTextNodes(node: Node | null): Node | null;
/**
 ...
 * @return Whether the element is a top-level editable container.
 */
export declare function isEditableContainer(element: Node | null): boolean;
/**
 * Checks if a node is inside an editable container.
 * @param node The node to test.
 * @return Whether the node is in an editable container.
 */
export declare function isEditable(node: Node | null): boolean;
/**
 ...
 * @return The DOM node if found, or null.
 */
export declare function findTopMostEditableAncestor(node: Node | null, criteria: () => boolean): Node | null;
/**
 ...
 */
export declare function splitDomTreeAt(currentNode: Node, opt_secondHalf?: Node | null, opt_root?: Node | null): Node;
/**
 ...
 */
export declare function transferChildren(newNode: Node, oldNode: Node | null): void;
/**
 ...
 */
export declare function replaceInnerHtml(node: Node | null, html: string): void;
