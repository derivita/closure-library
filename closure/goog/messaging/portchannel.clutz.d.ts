//!! generated by clutz.
// Generated from messaging/portchannel.js
declare namespace ಠ_ಠ.clutz.goog.messaging {
   ...
   * sends.
   */
  class PortChannel extends ಠ_ಠ.clutz.goog.messaging.AbstractChannel {
    private noStructuralTyping_goog_messaging_PortChannel : any;
    /**
     * A wrapper for several types of HTML5 message-passing entities
     * ({@link MessagePort}s and {@link Worker}s). This class implements the
     * {@link goog.messaging.MessageChannel} interface.
     ...
     */
    send (serviceName : string , payload : string | GlobalObject | MessagePort ) : void ;
    /**
     ...
     */
    static forEmbeddedWindow (peerWindow : Window , peerOrigin : string , opt_timer ? : ಠ_ಠ.clutz.goog.Timer | null ) : ಠ_ಠ.clutz.goog.messaging.DeferredChannel ;
    /**
...
declare module 'goog:goog.messaging.PortChannel' {
  import PortChannel = ಠ_ಠ.clutz.goog.messaging.PortChannel;
  export default PortChannel;
}
