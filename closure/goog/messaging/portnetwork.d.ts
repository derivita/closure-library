...
export interface PortNetwork {
     ...
     * @return The channel communicating with the given context. This is either a {@link goog.messaging.PortChannel} or a decorator around a PortChannel, so it's safe to send {@link MessagePorts} across it. This will be disposed along with the PortNetwork.
     */
    dial(name: string): MessageChannel | null;
}
export declare namespace PortNetwork {
    /**
