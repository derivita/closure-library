//!! generated by clutz.
// Generated from fx/css3/transition.js
declare namespace ಠ_ಠ.clutz.goog.fx.css3 {
   ...
   * </pre>
   */
  class Transition extends ಠ_ಠ.clutz.goog.fx.TransitionBase {
    private noStructuralTyping_goog_fx_css3_Transition : any;
    /**
     * A class to handle targeted CSS3 transition. This class
     * handles common features required for targeted CSS3 transition.
     *
     ...
     * @param initialStyle Initial style properties of the element before animating. Set using `goog.style.setStyle`.
     * @param finalStyle Final style properties of the element after animating. Set using `goog.style.setStyle`.
     * @param transitions A single CSS3 transition property or an array of it.
     */
    constructor (element : GlobalElement | null , duration : number , initialStyle : GlobalObject | null , finalStyle : GlobalObject | null , transitions : ಠ_ಠ.clutz.goog.style.transition.Css3Property | null | ( ಠ_ಠ.clutz.goog.style.transition.Css3Property | null ) [] ) ;
...
declare module 'goog:goog.fx.css3.Transition' {
  import Transition = ಠ_ಠ.clutz.goog.fx.css3.Transition;
