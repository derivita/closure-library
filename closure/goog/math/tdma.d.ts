 ...
 * @return The vector that is the solution to the system.
 */
export declare function solve(subDiag: number[], mainDiag: number[], supDiag: number[], vecRight: number[], opt_result?: number[] | null): number[];
