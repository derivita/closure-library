...
export declare class Path {
     ...
     */
    constructor();
    private noStructuralTyping_closure_goog_math_path_Path;
    /**
     ...
     * @return The path itself.
     */
    curveToFromArray(coordinates: number[]): Path;
    /**
     ...
     * @return The path itself.
     */
    arc(cx: number, cy: number, rx: number, ry: number, fromAngle: number, extent: number, connect: boolean): Path;
    /**
     ...
     * @return The path itself.
     */
    arcTo(rx: number, ry: number, fromAngle: number, extent: number): Path;
    /**
     ...
     * @return The path itself.
     */
    arcToAsCurves(rx: number, ry: number, fromAngle: number, extent: number): Path;
    /**
     ...
     */
    forEachSegment(callback: () => any): void;
    /**
     * Returns the coordinates most recently added to the end of the path.
     * @return An array containing the ending coordinates of the path of the form {@code [x, y]}.
     */
     ...
     * @return True if the path contains no arcs.
     */
    isSimple(): boolean;
    /**
     ...
     */
    static createSimplifiedPath(src: Path): Path;
    /**
     ...
     * @return A new, transformed path.
     */
    createTransformedPath(tx: AffineTransform): Path;
    /**
