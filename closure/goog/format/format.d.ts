 ...
 * @return The human readable form of the byte size.
 */
export declare function fileSize(bytes: number, opt_decimals?: number): string;
/**
 ...
 * @return True if string could be converted to a numeric value.
 */
export declare function isConvertableScaledNumber(val: string): boolean;
/**
 ...
 */
export declare function stringToNumericValue(stringValue: string): number;
/**
 ...
 * @return Numeric value for string.
 */
export declare function stringToNumBytes(stringValue: string): number;
/**
 ...
 */
export declare function numericValueToString(val: number, opt_decimals?: number): string;
/**
 ...
 * @return String representation of number of bytes.
 */
export declare function numBytesToString(val: number, opt_decimals?: number, opt_suffix?: boolean, opt_useSeparator?: boolean): string;
/**
 ...
 * @return The string including word breaks.
 */
export declare function insertWordBreaks(str: string, opt_maxlen?: number): string;
/**
 * Inserts word breaks into an HTML string at a given interval.
 *
 ...
 * @return The string including word breaks.
 */
export declare function insertWordBreaksBasic(str: string, opt_maxlen?: number): string;
/**
 ...
 * use &lt;wbr&gt;.
 */
export declare var WORD_BREAK_HTML: string;
