export declare var FORCE_NON_DOM_HTML_UNESCAPING: boolean;
/**
 ...
 */
export declare function endsWith(a: string, b: string): boolean;
/**
 ...
 */
export declare function caseInsensitiveStartsWith(a: string, b: string): boolean;
/**
 ...
 */
export declare function caseInsensitiveEndsWith(a: string, b: string): boolean;
/**
 ...
 * @return A copy of `str` in which each occurrence of {@code %s} has been replaced an argument from `var_args`.
 */
export declare function subs(str: string, ...var_args: any[]): string;
/**
 * Converts multiple whitespace chars (spaces, non-breaking-spaces, new lines
 * and tabs) to a single space, and strips leading and trailing whitespace.
 * @param str Input string.
 * @return A copy of `str` with collapsed whitespace.
 */
 ...
 */
export declare function isEmptyOrWhitespace(a: string): boolean;
/**
 ...
 * @return Whether `str` is empty or whitespace only.
 */
export declare function isEmpty(a: string): boolean;
/**
 * Checks if a string is null, undefined, empty or contains only whitespaces.
 * @param str The string to check.
 * @return Whether `str` is null, undefined, empty, or whitespace only.
 */
export declare function isEmptyOrWhitespaceSafe(str: any): boolean;
/**
 * Checks if a string is null, undefined, empty or contains only whitespaces.
 * @param str The string to check.
 * @return Whether `str` is null, undefined, empty, or whitespace only.
 */
export declare function isEmptySafe(a: any): boolean;
/**
 * Checks if a string is all breaking whitespace.
 * @param str The string to check.
 * @return Whether the string is all breaking whitespace.
 */
export declare function isBreakingWhitespace(str: string): boolean;
/**
 * Checks if a string contains all letters.
 * @param str string to check.
 * @return True if `str` consists entirely of letters.
 */
 ...
 */
export declare function isUnicodeChar(ch: string): boolean;
/**
 * Takes a string and replaces newlines with a space. Multiple lines are
 * replaced with a single space.
 * @param str The string from which to strip newlines.
 * @return A copy of `str` stripped of newlines.
 */
 ...
 * @return `str` A copy of {@code} with canonicalized newlines.
 */
export declare function canonicalizeNewlines(str: string): string;
/**
 ...
 * @return A copy of `str` with all consecutive spaces and tabs replaced with a single space.
 */
 ...
 */
export declare function collapseBreakingSpaces(str: string): string;
/**
 * Trims white spaces to the left and right of a string.
 * @param str The string to trim.
 * @return A trimmed copy of `str`.
 */
export declare function trim(a: string): string;
/**
 ...
 */
export declare function caseInsensitiveCompare(a: string, b: string): number;
/**
 ...
 * @param str2 The string to compare `str1` to.
 * @return less than 0 if str1 < str2, 0 if str1 == str2, greater than 0 if str1 > str2.
 */
export declare function intAwareCompare(str1: string, str2: string): number;
/**
 ...
 * @return less than 0 if str1 < str2, 0 if str1 == str2, greater than 0 if str1 > str2.
 */
export declare function floatAwareCompare(str1: string, str2: string): number;
/**
 * Alias for {@link floatAwareCompare}.
 */
export declare function numerateCompare(a: string, b: string): number;
/**
 * URL-encodes a string
 * @param str The string to url-encode.
 * @return An encoded copy of `str` that is safe for urls. Note that '#', ':', and other characters used to delimit portions of URLs *will* be encoded.
 */
export declare function urlEncode(str: any): string;
/**
 ...
 */
export declare function urlDecode(str: string): string;
/**
 * Converts \n to <br>s or <br />s.
 ...
 */
export declare function newLineToBr(a: string, b?: boolean): string;
/**
 ...
 * @return An unescaped copy of `str`.
 */
export declare function unescapeEntities(str: string): string;
/**
 ...
 * @return An unescaped copy of `str`.
 */
export declare function unescapeEntitiesWithDocument(str: string, document: Document): string;
/**
 * Unescapes an HTML string using a DOM to resolve non-XML, non-numeric
 * entities. This function is XSS-safe and whitespace-preserving.
 * @param str The string to unescape.
 * @param opt_document An optional document to use for creating elements. If this is not specified then the default window.document will be used.
 * @return The unescaped `str` string.
 */
export declare function unescapeEntitiesUsingDom_(str: string, opt_document?: Document | null): string;
/**
 * Unescapes XML entities.
 * @param str The string to unescape.
 * @return An unescaped copy of `str`.
 */
export declare function unescapePureXmlEntities_(str: string): string;
/**
 ...
 * @return A copy of `str` with preserved whitespace.
 */
export declare function preserveSpaces(str: string): string;
/**
 ...
 * @return A copy of `str` without the quotes.
 */
export declare function stripQuotes(str: string, quoteChars: string): string;
/**
 ...
 */
export declare function truncate(str: string, chars: number, opt_protectEscapedCharacters?: boolean): string;
/**
 ...
 * @return A truncated copy of `str`.
 */
export declare function truncateMiddle(str: string, chars: number, opt_protectEscapedCharacters?: boolean, opt_trailingChars?: number): string;
/**
 * Encloses a string in double quotes and escapes characters so that the
 * string is a valid JS string. The resulting string is safe to embed in
 * `<script>` tags as "<" is escaped.
 * @param s The string to quote.
 * @return A copy of `s` surrounded by double quotes.
 */
export declare function quote(s: string): string;
/**
 * Takes a string and returns the escaped string for that input string.
 * @param str The string to escape.
 * @return An escaped string representing `str`.
 */
 ...
 * @return An escaped string representing `c`.
 */
export declare function escapeChar(c: string): string;
/**
 ...
 * @return Whether `str` contains `subString`.
 */
export declare function caseInsensitiveContains(a: string, b: string): boolean;
/**
 ...
 */
export declare function countOf(s: string, ss: string): number;
/**
 ...
 * @return A copy of `s` with the substring removed or the full string if nothing is removed or the input is invalid.
 */
export declare function removeAt(s: string, index: number, stringLength: number): string;
/**
 * Removes the first occurrence of a substring from a string.
 * @param str The base string from which to remove.
 * @param substr The string to remove.
 * @return A copy of `str` with `substr` removed or the full string if nothing is removed.
 */
export declare function remove(str: string, substr: string): string;
/**
 * Removes all occurrences of a substring from a string.
 * @param s The base string from which to remove.
 * @param ss The string to remove.
 * @return A copy of `s` with `ss` removed or the full string if nothing is removed.
 */
export declare function removeAll(s: string, ss: string): string;
/**
 * Replaces all occurrences of a substring of a string with a new substring.
 * @param s The base string from which to remove.
 * @param ss The string to replace.
 * @param replacement The replacement string.
 * @return A copy of `s` with `ss` replaced by `replacement` or the original string if nothing is replaced.
 */
export declare function replaceAll(s: string, ss: string, replacement: string): string;
/**
 * Escapes characters in the string that are not safe to use in a RegExp.
 * @param s The string to escape. If not a string, it will be casted to one.
 * @return A RegExp safe, escaped copy of `s`.
 */
export declare function regExpEscape(s: any): string;
/**
 * Repeats a string n times.
 * @param string The string to repeat.
 * @param length The number of times to repeat.
 * @return A string containing `length` repetitions of `string`.
 */
export declare function repeat(string: string, length: number): string;
/**
 ...
 * @return `num` as a string with the given options.
 */
export declare function padNumber(num: number, length: number, opt_precision?: number): string;
/**
 ...
 */
export declare function makeSafe(obj: any): string;
/**
 ...
 */
export declare function compareVersions(a: string | number, b: string | number): number;
/**
 ...
 * (exclusive).
 * @param str A string.
 * @return Hash value for `str`, between 0 (inclusive) and 2^32 (exclusive). The empty string returns 0.
 */
 ...
 */
export declare function isLowerCamelCase(str: string): boolean;
/**
 ...
 */
export declare function isUpperCamelCase(str: string): boolean;
/**
 ...
 */
export declare function toSelectorCase(str: string): string;
/**
 ...
 */
export declare function toTitleCase(str: string, opt_delimiters?: string): string;
/**
 ...
 * @return The number, parsed. If the string failed to parse, this will be NaN.
 */
declare function parseInt_(value: string | number | null | undefined): number;
 ...
 */
export declare function splitLimit(str: string, separator: string, limit: number): string[];
/**
 ...
 * @return The last part of the string with respect to the separators
 */
export declare function lastComponent(str: string, separators: string | string[]): string;
/**
