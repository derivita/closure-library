...
declare namespace ಠ_ಠ.clutz.goog.db {
   ...
   */
  function deleteDatabase (name : string , opt_onBlocked ? : ಠ_ಠ.clutz.goog.db.BlockedCallback ) : ಠ_ಠ.clutz.goog.async.Deferred ;
  /**
   ...
   * @param opt_onBlocked Called if there are active connections to the database.
   */
  function openDatabase (name : string , opt_version ? : number , opt_onUpgradeNeeded ? : ಠ_ಠ.clutz.goog.db.UpgradeNeededCallback , opt_onBlocked ? : ಠ_ಠ.clutz.goog.db.BlockedCallback ) : ಠ_ಠ.clutz.goog.async.Deferred ;
}
declare module 'goog:goog.db' {
  import db = ಠ_ಠ.clutz.goog.db;
  export = db;
}
// Generated from db/db.js
declare namespace ಠ_ಠ.clutz.goog.db {
...
declare module 'goog:goog.db.BlockedCallback' {
  import BlockedCallback = ಠ_ಠ.clutz.goog.db.BlockedCallback;
  export default BlockedCallback;
}
// Generated from db/db.js
declare namespace ಠ_ಠ.clutz.goog.db {
  /**
...
declare module 'goog:goog.db.UpgradeNeededCallback' {
  import UpgradeNeededCallback = ಠ_ಠ.clutz.goog.db.UpgradeNeededCallback;
  export default UpgradeNeededCallback;
}
