 ...
 */
export type BlockedCallback = () => any;
/**
 ...
 */
export type UpgradeNeededCallback = () => any;
/**
 * Opens a database connection and wraps it.
 * @param name The name of the database to open.
 * @param opt_version The expected version of the database. If this is larger than the actual version, opt_onUpgradeNeeded will be called (possibly after opt_onBlocked; see {@link BlockedCallback}). If this is passed, opt_onUpgradeNeeded must be passed as well.
 ...
 * @return The deferred database object.
 */
export declare function openDatabase(name: string, opt_version?: number, opt_onUpgradeNeeded?: UpgradeNeededCallback | null, opt_onBlocked?: BlockedCallback | null): Deferred;
/**
 * Deletes a database once all open connections have been closed.
 * @param name The name of the database to delete.
 * @param opt_onBlocked Called if there are active connections to the database.
 * @return A deferred object that will fire once the database is deleted.
 */
export declare function deleteDatabase(name: string, opt_onBlocked?: BlockedCallback | null): Deferred;
