 ...
 * @return If the currency is available.
 */
export declare function isAvailable(currencyCode: string): boolean;
/**
 ...
 */
export declare function addTier2Support(): void;
/**
 * Deprecated.
 ...
 * @return Global currency pattern string for given currency.
 */
export declare function getGlobalCurrencyPattern(currencyCode: string): string;
/**
 * Return global currency sign string for those applications
 * that want to handle currency sign themselves.
 * @param currencyCode ISO-4217 3-letter currency code.
 * @return Global currency sign for given currency.
 */
export declare function getGlobalCurrencySign(currencyCode: string): string;
/**
 * Return global currency sign string for those applications
 * that want to handle currency sign themselves.
 *
 ...
 * @return Global currency sign for given currency.
 */
export declare function getGlobalCurrencySignWithFallback(currencyCode: string): string;
/**
 * Deprecated.
 ...
 * currencies.
 * @param currencyCode ISO-4217 3-letter currency code.
 * @return Local currency pattern string for given currency.
 */
export declare function getLocalCurrencyPattern(currencyCode: string): string;
/**
 * Returns local currency sign string for those applications that need to
 * handle currency sign separately.
 * @param currencyCode ISO-4217 3-letter currency code.
 * @return Local currency sign for given currency.
 */
export declare function getLocalCurrencySign(currencyCode: string): string;
/**
 * Returns local currency sign string for those applications that need to
 * handle currency sign separately.
 *
 ...
 * @return Local currency sign for given currency.
 */
export declare function getLocalCurrencySignWithFallback(currencyCode: string): string;
/**
 * Deprecated.
 ...
 * @param currencyCode ISO-4217 3-letter currency code.
 * @return Portable currency pattern string for given currency.
 */
export declare function getPortableCurrencyPattern(currencyCode: string): string;
/**
 * Return portable currency sign string for those applications that need to
 * handle currency sign themselves.
 * @param currencyCode ISO-4217 3-letter currency code.
 * @return Portable currency sign for given currency.
 */
export declare function getPortableCurrencySign(currencyCode: string): string;
/**
 * Returns whether the string represents a valid ISO-4217 currency code.
 * @param currencyCode String to check.
 * @return Whether currencyCode is a 3-letter currency code.
 */
export declare function isValid(currencyCode: string): boolean;
/**
 * Return portable currency sign string for those applications that need to
 * handle currency sign themselves.
 *
 ...
 * @return Portable currency sign for given currency.
 */
export declare function getPortableCurrencySignWithFallback(currencyCode: string): string;
/**
 ...
 * displayed as '10,10 $'.
 * @param currencyCode ISO-4217 3-letter currency code.
 * @return true if currency should be positioned before amount field.
 */
export declare function isPrefixSignPosition(currencyCode: string): boolean;
/**
 ...
 * @return modified currency pattern string.
 */
export declare function adjustPrecision(pattern: string, currencyCode: string): string;
/**
 ...
 */
export declare var CurrencyInfo: {
    [key: string]: any[];
};
/**
 ...
 * {@link goog.i18n.NumberFormat.Format.CURRENCY} instead.
 */
export declare var CurrencyInfoTier2: {
    [key: string]: any[];
};
