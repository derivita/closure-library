 ...
 */
declare function declareIcuTemplate(templateString: string, options: IcuTemplateOptions): string;
declare const _default: {
    declareIcuTemplate: typeof declareIcuTemplate;
    IcuTemplateOptions: any;
};
