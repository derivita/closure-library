 ...
 */
export const CLOSURE_TO_TYPESCRIPT = {
  CSSProperties: "CSSStyleDeclaration",
  IteratorIterable: "IterableIterator",
  AsyncIteratorIterable: "AsyncIterableIterator",
  Generator: "IterableIterator",
  IArrayLike: "ArrayLike",
  Arguments: "IArguments",
  IThenable: "PromiseLike",
  IIterableResult: "IteratorResult",
  IDBKeyType: "IDBValidKey",
  DOMError: "DOMException",
  TextRange: "Range",  // seems like this was an ie6 thing.
};

/** Closure symbols that are templatized in Closure but not in TypeScript. */
export const NOT_TEMPLATIZED_IN_TYPESCRIPT = new Set([
  "Arguments",
  "NodeList",
  "MessageEvent",
  "NamedNodeMap",
 ...
 */
export const TYPESCRIPT_LIB_D_TS = new Set([
  "AAGUID",
