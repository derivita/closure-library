//!! generated by clutz.
// Generated from ../../third_party/closure/goog/mochikit/async/deferredlist.js
declare namespace ಠ_ಠ.clutz.goog.async {
   ...
   */
  class DeferredList extends ಠ_ಠ.clutz.goog.async.Deferred {
    private noStructuralTyping_goog_async_DeferredList : any;
    /**
     * Constructs an object that waits on the results of multiple asynchronous
     * operations and marshals the results. It is itself a <code>Deferred</code>,
     * and may have an execution sequence of callback functions added to it. Each
     ...
     */
    constructor (list : ಠ_ಠ.clutz.goog.async.Deferred [] , opt_fireOnOneCallback ? : boolean , opt_fireOnOneErrback ? : boolean , opt_consumeErrors ? : boolean , opt_canceler ? : Function | null , opt_defaultScope ? : GlobalObject | null ) ;
     ...
     */
    static gatherResults (list : ಠ_ಠ.clutz.goog.async.Deferred [] ) : ಠ_ಠ.clutz.goog.async.Deferred ;
  }
}
declare module 'goog:goog.async.DeferredList' {
  import DeferredList = ಠ_ಠ.clutz.goog.async.DeferredList;
